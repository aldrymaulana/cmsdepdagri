...
<p>Ce module permet la gestion et l&#039;administration des utilisateurs du site sur la partie publique <i>(utilisateurs qui n&#039;ont pas acc&egrave;s au panneau d&#039;administration)</i>. Il permet la cr&eacute;ation de groupes d&#039;utilisateurs, de comptes utilisateur, et permet aux utilisateurs de se connecter et se d&eacute;connecter. Il peut &ecirc;tre utilis&eacute; avec le module CustomContent pour afficher du contenu diff&eacute;rent selon les utilisateurs, une fois qu&#039;ils sont connect&eacute;s.</p>
<h3>Fonctionnalit&eacute;s</h3>
<ul>
<li><p>Expiration du compte utilisateur.  Vous pouvez cr&eacute;er des utilisateurs temporaires</p></li>
<li><p>Propri&eacute;t&eacute;s de groupe.  Vous pouvez demander des informations diff&eacute;rentes aux membres de diff&eacute;rents groupes</p></li>
<li><p>Peut g&eacute;rer des milliers d&#039;utilisateurs</p></li>
...
<li><p>Contient une API &eacute;tendue, pour l&#039;ajout de fonctionnalit&eacute;s</p></li>
</ul>
<h3>Comment l&#039;utiliser ?</h3>
<ul>
<li><p>Apr&egrave;s installation, vous pouvez acc&eacute;der au module FrontEndUsers par le panneau d&#039;administration sous le menu &quot;Groupes &amp; Utilisateurs&quot;.</p></li>
<li>
<p>Deuxi&egrave;mement, vous devrez d&eacute;finir au moins une propri&eacute;t&eacute;s. Les propri&eacute;t&eacute;s sont essentiellement des d&eacute;finitions de champ, vous pouvez ici d&eacute;finir le type d&#039;information que vous d&eacute;sirez collecter, et les limites. p.ex. Nom, Age, Ville, D&eacute;partement, Pays, Adresse email, etc. </p>
<p><b>Note:</b> Vous n&#039;avez pas besoin de d&eacute;finir les propri&eacute;t&eacute;s de l&#039;identifiant (ou adresse email ) et du mot de passe, ils sont cr&eacute;&eacute;s pour vous.</b></p>
<p><b>Note:</b> Les nouvelles installations du module FEU pr&eacute;cisent que l&#039;adresse e-mail  utilisateur est leur nom d&#039;utilisateur (cette option peut &ecirc;tre chang&eacute; dans l&#039;onglet Pr&eacute;f&eacute;rences). Donc, si vous utilisez cette option, vous n&#039;aurez pas besoin de cr&eacute;er une propri&eacute;t&eacute; adresse email.</p>
</li>
<li><p>Ensuite, vous pouvez cr&eacute;er un ou plusieurs nom(s) de groupe. Quand vous cr&eacute;ez un groupe, vous devez entrer un nom de groupe, une description et devez associer des propri&eacute;t&eacute;s au groupe, sp&eacute;cifier l&#039;ordre des propri&eacute;t&eacute;s, si celles-ci sont optionnelles, requises ou de champ cach&eacute;<i>(off est aussi valide)</i></p></li>
<li><p><b>Note :</b> Avant de continuer, veuillez vous assurer que les pr&eacute;f&eacute;rences sont d&eacute;finies correctement.</p></li>
<li><p>Troisi&egrave;mement, cr&eacute;ez les utilisateurs. L&#039;ajout d&#039;utilisateur est un processus en deux temps. Quand vous cr&eacute;ez un utilisateur, vous devez entrer un identifiant/email et un mot de passe, ainsi qu&#039;une date d&#039;expiration. Vous devez ensuite s&eacute;lectionner le ou les groupe(s) au(x)quel(s) cet utilisateur appartiendra, puis cliquer sur \&#039;Suivant\&#039;</p>
<p><em>Note : </em>Ceci est un travail long et laborieux, il est plus facile de laisser les utilisateurs s&#039;enregistrer eux-m&ecirc;mes. Puis vous pouvez &eacute;diter leur groupe d&#039;appartenance. Cependant, cr&eacute;ez au moins un utilisateur-test.</p></li>
<li><p>Enfin, apr&egrave;s que le syst&egrave;me ait d&eacute;termin&eacute; tous les champs &agrave; pr&eacute;senter &agrave; l&#039;utilisateur, vous verrez un formulaire qui vous demandera de d&eacute;finir tous les champs obligatoires. Remplissez ce formulaire pour terminer l&#039;ajout de l&#039;utilisateur.</p></li>
<li><p>Vous &ecirc;tes maintenant pr&ecirc;t &agrave; ajouter la fonction aux pages de votre site. C&#039;est tr&egrave;s simple, ajoutez la balise Smarty {cms_module module=FrontEndUsers} &agrave; votre page ou gabarit</p></li>
</ul>

<h3>Fonctions Smarty</h3>
<p>Quelques interactions avec la base de donn&eacute;es du module FrontEndUsers sont possibles avec smarty et l&#039;objet $feu_smarty.</p>
<h4>Fonctions :</h4>
<ul>
...
<p>Exemple :<br/><code>{$feu_smarty->get_users_by_groupname(&#039;members&#039;,&#039;mymembers&#039;)}<br/>{$mymembers|@print_r}</code></p>
</li>
...
<p>Exemple :<br/><code>{$feu_smarty->get_user_properties(5,&#039;userprops&#039;)}<br/>{$userprops|@print_r}</code></p>
</li>
...
<p>Exemple :<br/><code>{$feu_smarty->get_dropdown_text(&#039;age_range&#039;,$onepropvalue)}</code></p>
</li>
...
<p>Exemple :<br/><code>{$feu_smarty->get_multiselect_text(&#039;favorite_foods&#039;,$onepropvalue,&#039;favorite_foods&#039;)}<br/>{$favorite_foods|@print_r}</code></p>
</li>
</ul>
...
<ul>
<li>Pour la derni&egrave;re version de ce module, les FAQs, ou pour annoncer un bug, ou pour acheter du support commercial, veuillez visiter le site de calguy <a href="http://calguy1000.com">calguy1000.com</a>.</li>
...
<ul>
<li><em>(optionel)</em> action=&quot;default&quot;<li>
<p>Actions :
<ul>
...
<li><em>(optionel)</em> form=&quot;name&quot;</li>
<p>Formulaires :
<ul>
 <li><em>login</em> - Affiche le formulaire de connexion</li>
 <li><em>logout</em> - Affiche le formulaire de d&eacute;connexion</li>
 <li><em>changesettings</em> - Affiche le formulaire de changement de param&egrave;tres</li>
 <li><em>forgotpw</em> - Affiche le formulaire d&#039;oubli de mot de passe</li>
<li><em>silent</em> = N&#039;affiche rien, mais exporte les propri&eacute;t&eacute;s et autres variables smarty pour l&#039;utilisateur connect&eacute;. Si aucun utilisateur n&#039;est connect&eacute;, aucune variable n&#039;est export&eacute;e.</li>
</ul>
</p>
<li><em>(optionel)</em> returnto=&quot;page&quot;</li>
<p>Utilis&eacute; avec les formulaires de connexion, de d&eacute;connexion, et de changement de param&egrave;tres, ce param&egrave;tre contient l&#039;id ou l&#039;alias de la page &agrave; laquelle rediriger l&#039;utilisateur apr&egrave;s l&#039;envoi du formulaire, si celui-ci a &eacute;t&eacute; trait&eacute; avec succ&egrave;s</p>
<li><em>(optionel)</em> only_groups=&quot;group1, group2, group3&quot;</li>
<p>Utilis&eacute;s avec les formulaires de connexion. Autorise les utilisateurs &agrave; se connecter seulement s&#039;ils appartiennent aux groupe(s) sp&eacute;cifi&eacute;(s).</p>
<li><em>(optionel)</em> lostun_group=&quot;group&quot;</li>
<p>Utilis&eacute; avec le formulaire lostusername, cette fonction sp&eacute;cifie le groupe pour assumer de quel groupe les utilisateurs sont membres..</p>
<li><em>(optionel)</em> nocaptcha=&quot;1&quot;</li>
<p>Utilis&eacute; avec les formulaires de login. Cela d&eacute;sactivera la fonction captcha sur le formulaire. Par d&eacute;faut, si le module Captcha est install&eacute;, une validation d&#039;image Captcha sera requise pour se connecter. Ceci est une mesure de s&eacute;curit&eacute; pour &eacute;viter les attaques type &quot;brute force&quot;.</p>
<li><em>(optionel)</em> uid=null</li>
<p>Utilis&eacute; avec le param&egrave;tre &quot;viewuser&quot;.  Ce param&egrave;tre est exig&eacute; pour indiquer de quel utilisateur voir les d&eacute;tails.</p>
</ul>
...
<h3>Requis</h3>
<p>Pour l&#039;impl&eacute;mentation de la r&eacute;initialisation de mot de passe oubli&eacute;, ce module requiert que le module CMSMailer soit pr&eacute;alablement install&eacute; et correctement configur&eacute;.</p>
<h3>Copyright et Licence</h3>
<p>Copyright &copy; 2005, Robert Campbel <a href="mailto:calguy1000@hotmail.com"><calguy1000@hotmail.com></a>. Tous droits r&eacute;serv&eacute;s.</p>
...
<h3>Sponsors</h3>
<p>Quelques sponsors de ce module :</p>
<ul>
