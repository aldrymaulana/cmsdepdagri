<?php
$lang['pagelimit'] = 'Fichiers par page';
$lang['view'] = 'Voir ce fichier';
$lang['edit_this_file'] = 'Editer ce champ';
$lang['prompt_category_scannable'] = 'Scanner automatiquement la cat&eacute;gorie pour trouver les nouveaux fichiers ?';
$lang['info_category_scannable'] = 'Quand cette cat&eacute;gorie est vue depuis le site (FrontEnd), elle est automatiquement scann&eacute;e &agrave; la recherche de nouveaux fichiers';
...
$lang['error_filetoolarge'] = 'Le fichier que vous avez tent&eacute; d&#039;envoyer est plus gros que la taille maximale autoris&eacute;e par CMSMS';
...
$lang['info_replacefile'] = 'Vous pouvez envoyer un fichier de remplacement. Si ce fichier est une image, et que vous n&#039;avez pas transmis de vignette de remplacement, une vignette sera g&eacute;n&eacute;r&eacute;e automatiquement';
...
$lang['prompt_copy_files'] = 'Copier les fichiers de la cat&eacute;gorie';
$lang['info_copy_files'] = 'Copie les fichiers de la cat&eacute;gorie source vers la cat&eacute;gorie de destination';
$lang['extra'] = 'Extra ';
$lang['copy'] = 'Copier';
...
$lang['upload_file'] = 'Envoyer un nouveau fichier';
...
<ul>
<li><em>default</em> : fonctionnement par d&eacute;faut</li>
<li>detail : affiche le d&eacute;tail d&#039;un fichier en fonction du param&egrave;tre <em>upload_id</em></li>
<li>yousendit : affiche un formulaire pour l&#039;envoi d&#039;un fichier et son partage vers diff&eacute;rentes adresses en une op&eacute;ration</li>
</ul>';
$lang['param_sendfilepage'] = 'Sp&eacute;cifie l&#039;ID ou l&#039;alias de la page qui doit &ecirc;tre utilis&eacute;e pour le formulaire d&#039;envoi de fichier';
$lang['file_uploaded'] = 'Fichier upload&eacute; avec succ&egrave;s';
$lang['to'] = 'A';
$lang['title_yousenditform_template'] = 'Ajout/Modification de gabarit d&#039;envoi YouSendIt';
$lang['yousenditform_template'] = 'Gabarits d&#039;envoi YouSendIt';
$lang['title_yousenditform_sysdefault'] = 'Gabarit &quot;YouSendIt&quot; par d&eacute;faut du syst&egrave;me';
$lang['msg_file_sent'] = 'Un message a &eacute;t&eacute; envoy&eacute; aux adresses s&eacute;lectionn&eacute;es. Il contient des informations &agrave; propos du fichier sur la mani&egrave;re de le r&eacute;cup&eacute;rer.';
...
$lang['legend_uploadform'] = 'Envoyer un fichier';
...
$lang['param_sortorder'] = '  <p>Ordres de tri
  ...
  <li><em>downloads_asc</em> - Tri&eacute; par nombre de t&eacute;l&eacute;chargement croissant</li>
  <li><em>downloads_desc</em> - Tri&eacute; par nombre de t&eacute;l&eacute;chargement d&eacute;croissant</li>
...
$lang['newthumbnail'] = 'Envoyer une nouvelle vignette';
...
$lang['title_dummy_index_html'] = 'Cr&eacute;er un fichier index.html dans chaque r&eacute;pertoire ?<br/><em>Ne remplacera pas le fichier index.html s&#039;il en existe d&eacute;j&agrave; un</em>&nbsp;';
...
$lang['detail_template'] = 'Gabarits de d&eacute;tail';
...
$lang['friendlyname'] = 'Gestion de fichiers sur le site';
...
the &quot;summary&quot; mode.</p>
<h3>Scan automatique des cat&eacute;gories</h3>
...
<h3>Gestion des acc&egrave;s avec le module FEU</h3>
...
<h3>Blocks de contenu <em>(depuis CMSMS 1.7 +)</em></h3>
...
<p>Ce block de contenu accepte aussi les param&egrave;tres optionnels suivants :</p>
<ul>
  <li><u>selectone</u>
...
<h3>Obsolescence :</h3>
<p><strong>Note :</strong> la g&eacute;n&eacute;ration de vignette et de filigrane g&eacute;r&eacute;e par ce module est obsol&egrave;te et va &ecirc;tre retir&eacute;e dans les prochaines versions. Le module CGSmartImage vous sera plus utile et poss&egrave;des des fonctions plus avanc&eacute;es.</p>
...
<p><strong>Attention</strong> - La bonne marche de ce module d&eacute;pend de plusieurs variables php. Cela inclus <em>(mais pas seulement)</em> php&#039;s memory_limit, safe_mode, file_uploads, uploads_max_filesize et max_execution_time. Ces variables devront peut-&ecirc;tre &ecirc;tre ajust&eacute;es pour que le module fonctionne correctement sur votre site. Il vous est conseill&eacute; de travailler avec votre h&eacute;bergeur ou administrateur pour configurer ces param&egrave;tres.</p>';
$lang['postuninstall'] = 'Le module Uploads a &eacute;t&eacute; supprim&eacute;. Aucun fichier n&#039;a &eacute;t&eacute; supprim&eacute; de votre r&eacute;pertoire de t&eacute;l&eacute;chargement et l&#039;int&eacute;grit&eacute; des fichiers a &eacute;t&eacute; pr&eacute;serv&eacute;e.';
...
$lang['submit'] = 'Envoyer';
$lang['summary_template'] = 'Gabarits de sommaire';
$lang['summary'] = 'Titre / r&eacute;sum&eacute;';
