...
$lang['installed'] = 'Moduł Gallery w wersji %s został zainstalowany';
$lang['upgraded'] = 'Moduł Gallery został zaktualizowany do wersji %s.';
$lang['postuninstall'] = 'Moduł Gallery został odinstalowany';
$lang['uninstalled'] = 'Moduł Gallery został odinstalowany';
$lang['really_uninstall'] = 'Czy na pewno chcesz odinstalować moduł Gallery? Nie wpłynie to na obrazy, ale wszystkie komentarze i miniaturki stworzone przez moduł zostaną utracone.';
$lang['tinymce_description_picker'] = 'Pozwala łatwo wkleić foto galerie.';
...
$lang['dirtag'] = 'Tag wyświetlający tę podkategorię';
...
$lang['noalbumcover'] = 'Podgalerie nie posiadają okładki albumu';
...
$lang['imageupdated'] = 'Szczeg&oacute;ły obrazka zostały uaktualnione.';
...
$lang['prompt_visible'] = 'Widoczne w rozwijanej liście szablonu';
$lang['prompt_newtemplate'] = 'Stw&oacute;rz nowy szablon';
$lang['makevisible'] = 'Zr&oacute;b widoczne w rozwijanej liście szablon&oacute;w - dla użytkownik&oacute;w bez praw do modyfikacji szablon&oacute;w';
$lang['makeinvisible'] = 'Zr&oacute;b niewidoczne w rozwijanej liście szablon&oacute;w - dla użytkownik&oacute;w bez praw do modyfikacji szablon&oacute;w';
$lang['title_importxml'] = 'Zaimportuj szablon poprzez plik XML';
$lang['importxmlnote'] = 'XML files containing various Gallery templates can be found at the Module Forge <a href="http://dev.cmsmadesimple.org/projects/gallery/">Gallery page</a>. Watch the release-notes before uploading!';
$lang['importxml'] = 'Importuj szablon XML';
$lang['overwrite'] = 'Nadpisz istniejące szablony modułu';
$lang['title_singleimg_template'] = 'Szablon dla modułu dla pojedynczych obraz&oacute;w';
...
$lang['showallimages'] = 'Pozostawienie pustego wyświetli obrazy bez link&oacute;w';
...
$lang['deletefield'] = 'Skasuj ostatni rząd';
$lang['prompt_template'] = 'Źr&oacute;dło szablonu';
$lang['prompt_templatejs'] = 'Szablon JavaScript';
$lang['prompt_templatecss'] = 'Szablon CSS';
$lang['resetoriginal'] = 'Przywr&oacute;ć ustawienia oryginalne';
$lang['resetoriginalwarning'] = 'Jesteś pewien że chcesz zresetować kod szablonu do ustwień oryginalnych?';
...
$lang['maxlength_help'] = 'Dotyczy tylko p&oacute;l typu Text Input';
...
$lang['urlprefix_help'] = 'To tylko ma zastosowanie, gdy włączony jest mechanizm pretty URLs (kr&oacute;tkie adresy URL) przez tryb mod_rewrite lub przez wewnętrzny mechanizm pretty urls.';
$lang['allowed_extensions'] = 'Dozwolone rozszerzenia';
$lang['maxsize'] = 'Przed załadowaniem, przeskaluj duże obrazy do tych maksymalnych wartości';
$lang['use_comment_wysiwyg'] = 'Użyj edytora WYSIWYG w polu komentarza';
$lang['editdirdates'] = 'Pozw&oacute;l użytkownikom na edycję daty stworzenia subgalerii';
$lang['editfiledates'] = 'Pozw&oacute;l użytkownikom na edycję plik&oacute;w z obrazami';
$lang['fe_folderpath'] = 'Ścieżka do domyślnego folderu ikon dla frontendu';
$lang['be_folderpath'] = 'Ścieżka do folderu ikon dla backendu';
...
$lang['help_template'] = 'Użyj osobnego szablonu z bazy danych do wyświetlenia fotogalerii. Szablon musi istnieć i być widoczny w zakładce w panelu Galerii, ale nie musi być domyślny. Jeśli ten parametr nie jest określony, szablon przypisany do folderu zostanie użyty zamiast szablonu domyślnego.';
$lang['help_targetpage'] = 'Strona do wyświetlenia Galerii. Może to być zar&oacute;wnoalias strony jak i numer id. Dzięki temu możliwe jest wyświetlenie Galerii w r&oacute;żnych szablonach strony.';
$lang['help_number'] = 'Maksymalna liczba miniatur do wyświetlenia na stronę. Pozostaw puste aby wyświetlić wszystkie.';
$lang['help_start'] = 'Zacznij od n obrazu. Pozostawienie pustego wyświetli obrazy począwszy od pierwszego.';
...
';
$lang['help_img'] = 'Wywołuje pojedynczy obraz <code>{Gallery img=123}</code>. Kod html może być modyfikowany w zakładce z szablonami. Rozmiar miniatury i system Javascript może być ustawiony poprzez wybranie szablonu z listy rozwijanej.';
...
<p>Gallery templates can be separately downloaded from the <a href="http://dev.cmsmadesimple.org/projects/gallery/">Gallery module Forge</a>. The import session will overwrite if the checkbox is on and the name of the template already exists. Note that an update of the Gallery module will not affect your module templates.</p>
...
';
$lang['utma'] = '156861353.130117701.1281030249.1290700279.1290707142.23';
$lang['utmz'] = '156861353.1290707142.23.19.utmccn=(referral)|utmcsr=cmsms.org|utmcct=/|utmcmd=referral';
