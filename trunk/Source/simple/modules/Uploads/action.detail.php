...
// canonical url.
$prettyurl = "uploads/file/$returnid/".$data['upload_id'].'/'.urlencode($data['upload_name']);
$row->canonical = $this->CreateFrontendLink($id,$returnid,'detail','',
																						array('upload_id'=>$params['upload_id']),
																						'', true, true, '', false,
																						$prettyurl);
...
$this->smarty->assign('size',$this->Lang('size'));
