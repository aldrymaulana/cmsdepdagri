<?php
$lang['project'] = 'کد امنیتی';
$lang['msg_changes'] = 'ذخیره تغییرات';
$lang['friendlyname'] = 'کد امنیتی';
$lang['postinstall'] = 'ماژول مربوط به کد امنیتی با موفقیت نصب شد.';
$lang['postuninstall'] = 'ماژول مربوط به کد امنیتی با موفقیت حذف شد.';
$lang['really_uninstall'] = 'شما اطمینان به حذف ماژول کد امنیتی دارید ؟ ممکن است ماژول&zwnj;های دیگر دچار اختلال شوند ! آیا برای این عمل اطمینان دارید ؟';
$lang['uninstalled'] = 'مآژول حذف شد ';
$lang['installed'] = 'نسخه %s ماژول نصب شد !';
$lang['upgraded'] = 'ماژول به نسخه %s بروزرسانی شد !';
$lang['moddescription'] = 'فعال&zwnj;سازی کد امنیتی برای دیگر ماژول&zwnj;ها.';
$lang['error'] = 'خطا !';
$lang['err_no_gd_support'] = 'سرور شما از کتابخانه GD پشتیبانی نمی&zwnj;کند.';
$lang['err_no_jpg_support'] = 'کتابخانه GD نصب شده بر روی سرور شما JPG را پشتیبانی نمی&zwnj;کند.';
$lang['err_no_freetype_support'] = 'کتابخانه GD نصب شده بر روی سرور شما FreeType  را پشتیبانی نمی&zwnj;کند.';
$lang['admindescription'] = 'تنظیمات کد امنیتی';
$lang['accessdenied'] = 'دسترسی محدود ! لطفاً سطح دسترسی را بررسی نمایید !';
$lang['title_general'] = 'عمومی';
$lang['title_cache'] = 'ذخیره ساز';
$lang['legend_pear'] = 'PEAR کد امنیتی';
$lang['label_enable_pear'] = 'Enable PEAR Text/Captcha (must be installed, see the Captcha module help)';
$lang['legend_active_lib'] = 'فعال شدن کتابخانه';
$lang['label_captchalib_select'] = 'Captcha Library to use';
$lang['msg_active_lib_changed'] = 'Active library changed to %s';
$lang['msg_no_changes'] = 'بدون تغییرات';
...
$lang['legend_cache'] = 'ذخیره ساز';
$lang['label_clear_cache'] = 'حذف تمامی تصاویر در پوشه ذخیره ساز';
$lang['msg_cache_overview'] = 'تعداد %s فایل تصویر در پوشه ذخیره ساز وجود دارند.';
$lang['cache_directory'] = 'پوشه ذخیره ساز';
$lang['msg_deleted_cache'] = 'تعداد %s تصویر از پوشه ذخیره ساز حذف شدند.';
$lang['msg_deleted_cache_single'] = 'یک تصویر از پوشه ذخیره ساز حذف شد.';
$lang['legend_fonts'] = 'قلم&zwnj;ها';
$lang['label_font_path'] = 'پوشه قلم&zwnj;ها';
$lang['available_fonts'] = 'قلم&zwnj;های موجود';
$lang['restore'] = 'بازگشت به تنظیمات پیشفرض';
$lang['msg_restored_defaults'] = 'بازگشت مقدارها به پیشفرض';
$lang['changelog'] = '<ul>
<li>
