...
if (!isset($gCms)) exit;
	...
	/*---------------------------------------------------------
	  ...
	  ---------------------------------------------------------*/
		...
		$sqlarray = $dict->CreateTableSQL(cms_db_prefix()."module_gallery2embedded",
				$flds, $taboptarray);
		$dict->ExecuteSQLArray($sqlarray);

		// create a sequence
		$db->CreateSequence(cms_db_prefix()."module_gallery2embedded_seq");
		*/
		
		// permissions
		$this->CreatePermission('g2_show','g2_show');
