...
if (!isset($gCms)) exit;
	...
	/*---------------------------------------------------------
	  ...
	  ---------------------------------------------------------*/
		...
		$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_gallery2embedded" );
		$dict->ExecuteSQLArray($sqlarray);

		// remove the sequence
		$db->DropSequence( cms_db_prefix()."module_gallery2embedded_seq" );
		*/
		
		// remove the permissions
		$this->RemovePermission('g2_show');
