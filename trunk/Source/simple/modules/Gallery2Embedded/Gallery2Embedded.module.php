<?php
#-------------------------------------------------------------------------
# Module: Gallery2Embedded - This module is made to embedding Gallery2 (http://gallery2.menalto.com).    To make this module works, you need to install a full version of adoDB (not adoDB_lite) and change config.php to use adoDB instead of adoDB_lite.
...
#-------------------------------------------------------------------------
class Gallery2Embedded extends CMSModule
{

	function GetName()
	{
		return 'Gallery2Embedded';
	}
	...
	/*---------------------------------------------------------
	   ...
	   {cms_module module='Gallery2Embedded' param1=val param2=val...}
	...
	/*---------------------------------------------------------
	  ...
	  ---------------------------------------------------------*/
	function CheckAccess($perm = 'g2_show')
		{
	...
	function LoadGalleryApi()
	{
		$cmspath = realpath(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..');
		
		if (is_file($this->GetPreference('gallery_path') . DIRECTORY_SEPARATOR . 'embed.php'))
		{
			require_once ($this->GetPreference('gallery_path') . DIRECTORY_SEPARATOR . 'embed.php');
			return true;
		}
		elseif(is_file( $cmspath . DIRECTORY_SEPARATOR . $this->GetPreference('gallery_path') . DIRECTORY_SEPARATOR . 'embed.php'))
		{
			require_once ($cmspath . DIRECTORY_SEPARATOR . $this->GetPreference('gallery_path') . DIRECTORY_SEPARATOR . 'embed.php');
			return true;
		}
		else
		{
