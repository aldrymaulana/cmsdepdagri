...
$smarty->assign('msg',$this->Lang('info_ratings_templates_tab'));
$smarty->assign('templatelist',
		$this->ShowTemplateList($id,$returnid,'ratings_',
					CGFEEDBACK_PREF_NEWRATINGS_TEMPLATE,
					'ratingstemplates',
					CGFEEDBACK_PREF_DFLTRATINGS_NAME,
					$this->Lang('addedit_ratings_template'),
					$this->Lang('info_ratings_template')));
