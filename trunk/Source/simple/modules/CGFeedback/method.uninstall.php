...
$sqlarray = $dict->DropTableSQL(CGFEEDBACK_TABLE_FIELDVALS);
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL(CGFEEDBACK_TABLE_FIELDDEFS);
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL(CGFEEDBACK_TABLE_COMMENTS);
$dict->ExecuteSQLArray($sqlarray);
...
// Remove permissions
$this->RemovePermission(CGFEEDBACK_PERM_FEEDBACK);
