...
/**
  ...
  *____
  *
  * changes in version 1.2.1:   (2009-April-30)
  *
  *   - fixed a Bug with visibility-scope: set the functions "get_filename_url"
  *     and "get_filename" from private to protected, to work correctly again,
  *     when extending the baseclass.
  *
  *____
  *
  **/
