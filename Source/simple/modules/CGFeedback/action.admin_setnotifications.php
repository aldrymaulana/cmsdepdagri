...
# Initialization
#
$this->SetCurrentTab('notifications');
...
if( isset($params['reset']) )
...
else
  {
    if( isset($params['group']) )
      {
	$this->SetPreference('notification_group',(int)$params['group']);
      }
    if( isset($params['is_html']) )
      {
	$this->SetPreference('notification_ishtml',(int)$params['is_html']);
      }
    if( isset($params['subject']) )
      {
	$this->SetPreference(CGFEEDBACK_PREF_NOTIFICATION_SUBJECT,trim($params['subject']));
      }
    if( isset($params['notification_msg']) )
      {
	$txt = cms_html_entity_decode($params['notification_msg']);
	$this->SetTemplate(CGFEEDBACK_PREF_NOTIFICATION_TEMPLATE,$txt);
      }
  }
