...
<p>Mit diesem Modul k&ouml;nnen Benutzer sich selbst registrieren und die notwendigen Informationen eingeben. Danach wird eine Best&auml;tigungsemail mit einem Link zu einer zweiten Seite versandt, um die Registrierung zu vervollst&auml;ndigen. Nach dem erfolgreichen Abschluss wird im FrontendUsers-Modul ein neues Benutzer-Konto erstellt.</p>
<p>Um dieses Modul zu verwenden, m&uuml;ssen Sie im FrontendUser-Modul eine Eigenschaft vom Typ &#039;Email-Adresse&#039; erstellen und diese Eigenschaft dann mit der Gruppe verbinden, die f&uuml;r Selbstregistrierung eingesetzt werden soll.</p>
<h3>Wie wird es eingesetzt ?</h3>
<p>F&uuml;gen Sie den Tag {cms_module module=&#039;SelfRegistration&#039; group=&#039;Benutzergruppe&#039;} in Ihre Seite ein.</p>
<p>Damit das Modul funktioniert, m&uuml;ssen Sie jedoch zuvor die Benutzergruppen und deren Eigenschaften im FrontendUsers-Modul erstellt haben.</p>
<h3>Parameter</h3>
<p><strong>mode</strong>&nbsp;<em>optional</em> - m&ouml;gliche Werte sind &#039;signup&#039; und &#039;verify&#039;. Ohne Vorgabe ist &#039;signup&#039; der Standard.</p>
<p><strong>group</strong>&nbsp;<em>optional</em> - Dieser Parameter ist erforderlich, wenn der Modus &#039;signup&#039; ist oder nicht gesetzt wurde.</p>
<p><strong>nocaptcha</strong>&nbsp;<em>optional</em> - Dieser Parameter deaktiviert die Captcha-Funktionalit&auml;t im Registrierungsformular. Ist das Captcha-Modul installiert, wird diese Funktionalit&auml;t ansonsten automatisch verwendet.</p>
<h3>Support</h3>
...
<ul>
<li>F&uuml;r die letzte Version dieses Moduls, FAQs, dem Versand eines Fehlerreports oder dem Kauf kommerziellen Support besuchen Sie bitte calguys 
Homepage unter <a href="http://techcom.dyndns.org">techcom.dyndns.org</a>.</li>
...
<li>Letztlich k&ouml;nnen Sie den Autor auch direkt per Email kontaktieren.</li>    
</ul>
